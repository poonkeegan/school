    ...
    \item Consider the IVODE $y'' = y$ for $t \geq 0$, with initial values
        ...
        \begin{enumerate}
            ...
            \item Is the forward Euler method stable for this problem using
                ...
                First calculate the amplification matrix for this instance
                of FEM.
                \[ I + h_k f_y(t_k,\eta_k) = 
                \begin{pmatrix}
                    1 & 0 \\
                ...
                \end{pmatrix}
                \]
                The norm of this matrix is greater than one, so performing
                FEM must not be stable.

            \item Is the backward Euler method stable for this problem using
                this step size? Justify your answer.

                The backward Euler method is stable for the roblem
        \end{enumerate}
