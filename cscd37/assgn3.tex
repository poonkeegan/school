        ...
        \begin{enumerate}
            ...
            \item Derive the global error propagation formula for (1),
                ...
                \begin{align*} y(t_{k+1}) - y_{k+1} &= 
                    ...
                    + \frac{h^3}{3!}y'''(\psi) \\
                    y(t_{k+1}) - y_{k+1} &= 
                    [I(y(t_k) - y_k) + I(y(t_{k+0}) - y_{k+1})] \\
                    & + \frac{h}{2}
                    [f_y (t_k, \eta_k)(y(t_k) - y_k) 
                    + f_y (t_{k+1}, \eta_{k+1})(y(t_{k+1}) - y_{k+1})]
                    + \frac{h^3}{3!}y'''(\psi) \\
                    y(t_{k+1}) - y_{k+1} &= 
                    [I + \frac{h}{2}f_y (t_k, \eta_k)](y(t_k) - y_k) 
                    + [I + \frac{h}{2}f_y (t_{k+1}, \eta_{k+1})](y(t_{k+1}) 
                    - y_{k+1}) + \frac{h^3}{3!}y'''(\psi) \\
                \end{align*}
            \item When applied to the model problem $y'(t) = \lambda y(t),
                ...
                y_{k+1} - \lambda y_{k+1} &= 
                y_k \bigg( \frac{2 + h_k}{2(1-\lambda)}\bigg) \\
                \end{align*}
