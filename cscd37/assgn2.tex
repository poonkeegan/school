    ...
    \item Consider the definite integral $I(f) = \int_{-1}^1 f(x) \,dx$.
        ...
        \begin{enumerate}
            ...
            \begin{align*}
                ...
                \mathcal{Q}(x) &= \frac{-1}{9} + \frac{8(-1/2)}{9} + \frac{8(1/2)}{9} + \frac{1}{9} = 0 = \int_{-1}^1 x \, dx\\
                \mathcal{Q}(x^2) &= \frac{1}{9} + \frac{2}{9} + \frac{2}{9} + \frac{1}{9} \\
                \mathcal{Q}(f) &= \frac{f(-1)}{9} + \frac{8f(-1/2)}{9} + \frac{8f(1/2)}{9} + \frac{f(1)}{9} \\
                \mathcal{Q}(f) &= \frac{f(-1)}{9} + \frac{8f(-1/2)}{9} + \frac{8f(1/2)}{9} + \frac{f(1)}{9} \\
            \end{align*} 
