    ...
    \item Consider the definite integral $I(f) = \int_{-1}^1 f(x) \,dx$.
        ...
        \begin{enumerate}
            ...
            \begin{align*}
                ...
                &= -(2/3) ( x + 1/2)( x - 1/2)( x - 1)\\ 
                &= (1/6) (-4x^3+4x^2+x-1)\\ 
                l_2 &= \Big( \frac{x - x_2}{x_2 - x_1}\Big)\Big( \frac{x - x_3}{x_2 - x_3}\Big)\Big( \frac{x - x_4}{x_2 - x_4}\Big)\\ 
                l_2 &= \Big( \frac{x + 1/2}{-1/2 + 1}\Big)\Big( \frac{x - 1/2}{-1/2 - 1/2}\Big)\Big( \frac{x - 1}{-1/2 - 1}\Big)\\ 
                l_3 &= \Big( \frac{x - x_2}{x_1 - x_2}\Big)\Big( \frac{x - x_3}{x_1 - x_3}\Big)\Big( \frac{x - x_4}{x_1 - x_4}\Big)\\ 
