...
\begin{enumerate}
    ...
    \item In lecture we proved that the roots of the Chebyshev polynomial
        ...
        \begin{enumerate}
            ...
            \end{theorem}
            \begin{proof}
                Suppose $\display style \max_{x} |W(x)| < \max_{x} \Big| \frac{T_k(x)}{2^{k-1}}\Big|$, then in particular $|W(y_i)| < \Big| \frac{T_k(y_i)}{2^{k-1}}\Big| = \frac{1}{2^{k-1}}$ where $y_i = \cos\Big(\frac{i\pi}{k}\Big)$
            \end{proof}
        \end{enumerate}
    \newpage
