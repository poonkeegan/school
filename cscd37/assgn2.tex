    ...
    \item Consider the definite integral $I(f) = \int_{-1}^1 f(x) \,dx$.
        ...
        \begin{enumerate}
            ...
            \begin{align*}
                ...
                &= \frac{f^{(4)}(\eta(x))}{4!} \Big[ \int_{-1}^{-1/2} (x^2 - 1)(x^2 - 1/4) \, dx +\int_{-1/2}^{1/2}  (x^2 - 1)(x^2 - 1/4) \, dx +\int_{1/2}^{1} (x^2 - 1)(x^2 - 1/4) \, dx \\
                &\text{where $\eta$ is maxes $f^{(4)}$ over $\{ \eta_1,\, \eta_2,\, \eta_3\}$}\\
