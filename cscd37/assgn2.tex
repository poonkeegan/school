    ...
    \item Consider the definite integral $I(f) = \int_{-1}^1 f(x) \,dx$.
        ...
        \begin{enumerate}
            ...
            \begin{align*}
                ...
                &= \int_{-1}^{-1/2} \frac{f^{(4)}(\psi(x))}{4!} \cdot (x^2 - 1)(x^2 - 1/4) \, dx + \int_{-1/2}^{1/2} \frac{f^{(4)}(\psi(x))}{4!} \cdot (x^2 - 1)(x^2 - 1/4) \, dx + \int_{1/2}^{1} \frac{f^{(4)}(\psi(x))}{4!} \cdot (x^2 - 1)(x^2 - 1/4) \, dx \\
            \end{align*} 
        \end{enumerate}
\end{enumerate}
\end{document}
