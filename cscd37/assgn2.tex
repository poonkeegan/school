...
\begin{enumerate}
    ...
    \item Consider the definite integral $I(f) = \int_{-1}^1 f(x) \,dx$.
        ...
        \begin{enumerate}
            ...
            \end{align*} 
            Therefore, the quadrature rule integrates upto degree 3 polynomials perfectly since it integrates the monomial basis for polynomials of degree upto 3 perfectly.
