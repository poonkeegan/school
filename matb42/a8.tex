...
\begin{enumerate}
    ...
    \begin{align*}
        ...
        &= (\cos\theta (2 \cos\varphi + \cos^2\varphi), \sin\theta (2 \cos \varphi + \cos^2 \varphi) ,\\
        & \; 2\sin \varphi + \sin \varphi \cos \varphi ) \\
        \implies \norm {\boldsymbol \phi_{3_ \theta} \times \boldsymbol \phi_{3_ \varphi}} &= \sqrt{(2\cos \varphi  + \cos^2\varphi}
    \end{align*}
