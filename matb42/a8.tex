    ...
    \item Evaluate the (vector) surface integral $\displaystyle \int_S \boldsymbol F \cdot \, d \boldsymbol S$ in each of the following cases.
        \begin{enumerate}
            ...
            \begin{align*}
                ...
                &= \cos\theta \sin^2\varphi + (\cos\theta \sin\varphi)(\sin\theta \sin^2\varphi)+  (\cos\varphi)(\sin\varphi\cos\varphi)) \, d\theta \, d\varphi \\
                &= \cos\theta \sin^2\varphi + \cos\theta \sin\theta \sin^3\varphi + \sin\varphi\cos^2\varphi \, d\theta \, d\varphi
            \end{align*}
