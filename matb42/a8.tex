...
\begin{enumerate}
    ...
    \begin{align*}
        \int_{\boldsymbol \Phi_1} dS &= \int_0^1\int_0^{2\pi} 9\sqrt 2  - 9 \sqrt 2  u \, d\theta \, du = 9(2\pi) \sqrt 2  - 9\pi \sqrt 2\\
        \int_{\boldsymbol \Phi_1} dS &= \int_0^1\int_0^{2\pi} 9\sqrt 2  - 9 \sqrt 2  u \, d\theta \, du = 9\pi \sqrt 8  - 9\pi \sqrt 2\\
    \end{align*}
