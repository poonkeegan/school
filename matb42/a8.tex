...
\begin{enumerate}
    ...
    \begin{align*}
        ...
        \boldsymbol \phi_{1_u} &= (-3 \cos \theta, -3\sin \theta, 3) \\
        \boldsymbol \phi_{1_ \theta} &= (- (1-u) 3 \sin \theta, (1-u)3\cos\theta, 0) \\
        \boldsymbol \phi_{2_u} &= (3 \cos \theta, 3\sin \theta, -3) = - \boldsymbol \phi_{1_u} \\
        \boldsymbol \phi_{2_ \theta} &= (- (1+u) 3 \sin \theta, (1+u)3\cos\theta, 0) \\
    \end{align*}
