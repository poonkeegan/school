    ...
    \item Evaluate the (vector) surface integral $\displaystyle \int_S \boldsymbol F \cdot \, d \boldsymbol S$ in each of the following cases.
        \begin{enumerate}
            ...
            \begin{align*}
                ...
                \int_S \boldsymbol F \cdot \, d \boldsymbol S &= \int_0^{2\pi} \int_0^{\frac{\pi}{2}} \cos\theta \sin^2\varphi + (\cos\theta \sin\varphi)(\sin\theta \sin^2\varphi)+  (\cos\varphi)(\cos\varphi)) \, d\theta \, d\varphi
            \end{align*}
