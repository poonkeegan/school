...
\begin{enumerate}
    ...
    \item Let $S$ be the surface defined by $x^2 + y^2 = 1$ for $0 \leq z \leq 1$ and by $x^2 + y^2 = z^2$ for $1 \leq z \leq 2$.
        \begin{enumerate}
            ...
            \begin{align*}
                \boldsymbol  \phi_{1_u} \times \boldsymbol \phi_{1_\theta} = (-\cos \theta, -\sin \theta, 0) \boldsymbol  \phi_{1_u} \times \boldsymbol \phi_{1_\theta} = (-u\cos \theta, -u\sin \theta, u) \\
            \end{align*}
            Examining the rightmost point (If projected into the $xy$-plane), the 
        \end{enumerate}  
        \begin{enumerate}
