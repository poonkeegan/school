...
\begin{enumerate}
    ...
    \begin{align*}
        \int_0^1 \int_0^{1-x} \boldsymbol V (\boldsymbol \Phi) \cdot \boldsymbol n \, dy \, dx &= \int_0^1 \int_0^{1-x} (y,1-x+2y,x^2) \cdot (1, -2, 1) \, dy \, dx \\
        &= \int_0^1 \int_0^{1-x} y - 2 + 2 x - 4y + x^2 \, dy \, dx \\
        &= \int_0^1 \int_0^{1-x} - 2 + 2 x + x^2 - 3y \, dy \, dx \\
        &= \int_0^1 (- 2 + 2 x + x^2)(1-x) - \bigg[ \frac{3y^2}{2} \bigg]_0^{1-x} \, dx \\
        &= \int_0^1 (- 2 + 2 x + x^2)(1-x) - \frac{3(1-x)^2}{2} \, dx \\
        &= \int_0^1 (1-x)\bigg[- \frac{7}{2} + \frac{7x}{2} + x^2 \bigg]\, dx \\
        &= \int_0^1 \bigg[- \frac{7}{2} + \frac{7x}{2} + x^2 \bigg] -\bigg[- \frac{7x}{2} + \frac{7x^2}{2} + x^3 \bigg]\, dx \\
        &= \int_0^1 \bigg[- \frac{7}{2} + 7x -\frac{5x^2}{2} - x^3 \bigg]\, dx \\
        &= - \frac{7}{2} + \frac{7}{2} -\frac{5}{6} - \frac{1}{4} dx \\
    \end{align*} 
