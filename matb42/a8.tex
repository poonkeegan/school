...
\begin{enumerate}
    ...
    Since it is cutoff by coordinate planes we have $x,y\geq 0$. Now it is also cut off by the plane, so $x + y \leq 1$, or restated to have $y$ dependant on $x$, $0 \leq x \leq 1$ and $0 \leq y \leq 1- x$
