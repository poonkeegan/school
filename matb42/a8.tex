...
\begin{enumerate}
    ...
    \[ \boldsymbol \Phi (\theta, \varphi) = ((2+\cos\varphi)\cos \theta, (2+\cos\varphi)\sin \theta, \sin \phi)\]
    since it has radius 2 from the origin, and radius 1 from the center of the tube.

    (b) Use a computer algebra system to sketch $S$.

    \includegraphics[width=\textwidth]{b42-a8-1b}
    \newpage
