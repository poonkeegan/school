...
\begin{enumerate}
    ...
    \item Let $S$ be the surface defined by $x^2 + y^2 = 1$ for $0 \leq z \leq 1$ and by $x^2 + y^2 = z^2$ for $1 \leq z \leq 2$.
        \begin{enumerate}
            ...
            $S$ can be parametrized piecewise by $\boldsymbol \Phi (u, \theta) = (\cos \theta, \sin \theta, u)$ for $0 \leq u \leq 1$ and $\boldsymbol \Phi (u, \theta) = (u\cos \theta, u\sin \theta, u)$ for $1 \leq u \leq 2$
