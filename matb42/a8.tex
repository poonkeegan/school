    ...
    \item Let $S$ be the cone with vertex (2,3,3) and base the circle $x^2 + y^2 = 1$ in the $xy$-plane.
        \begin{enumerate}
            ...
            \begin{align*}
                ...
                \norm{ \boldsymbol \phi_\theta \times \boldsymbol \phi_u} &= \sqrt{(2(1-u)\cos \theta)^2 + (2(1-u)\sin \theta)^2 + (-(1-u)\sin \theta)(-\sin \theta + 3} \\
                \boldsymbol \phi_\theta \times \boldsymbol \phi_u &= ((2(1-u)\cos \theta),  (2(1-u)\sin \theta),  \\ 
                & \; (-(1-u)\sin \theta)(-\sin \theta + 3) - ((1-u)\cos\theta)(-\cos \theta + 2)) \\
                \boldsymbol \phi_\theta \times \boldsymbol \phi_u &= ((2-2u)\cos \theta,  (2-2u)\sin \theta, (1-u)\sin^2 \theta -(3 - 3u)\sin \theta + (1-u)\cos ^2 \theta - 2(1-u)\cos \theta)) \\
            \end{align*}
        \end{enumerate} 
