...
\begin{enumerate}
    ...
    \begin{align*}
        \iint_S \boldsymbol E \cdot d\boldsymbol S &= \int_0^1 \int_0^{2\pi} \int_0^{\frac{\pi}{2}} 6 \rho^2 \sin \varphi \, d\varphi \, d\theta \, d\rho  \\
        &= 12 \pi \int_0^1 \rho^2 \big[ -\cos \varphi\big]_0^{\frac{\pi}{2}} \, d\rho \\
        &= 12\pi\bigg[\frac{\rho^3}{3} \bigg]_0^1 = 4\pi
    \end{align*}
