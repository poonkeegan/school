...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}[label=(\roman*)]
            ...
            \[ \divt( \boldsymbol F + \boldsymbol G) = \sum_{i=1}^n \frac{\partial (F_i + G_i)}{\partial x_i} = \sum_{i=1}^n \frac{\partial F_i}{\partial x_i} + \frac{\partial G_i}{\partial x_i} = \sum_{i=1}^n \frac{\partial F_i}{\partial x_i} + \sum_{i=1}^n \frac{\partial G_i}{\partial x_i} = \divt F_i + \divt G_i\]
