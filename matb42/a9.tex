...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}[label=(\roman*)]
            ...
            \[ \divt( \boldsymbol F + \boldsymbol G) = \sum_{i=1}^n \frac{\partial (\boldsymbol F + \boldsymbol G)}{\partial x_i} = \sum_{i=1}^n \frac{\partial \boldsymbol F}{\partial x_i} + \frac{\partial \boldsymbol G}{\partial x_i} = \sum_{i=1}^n \frac{\partial \boldsymbol F}{\partial x_i} + \sum_{i=1}^n \frac{\partial \boldsymbol G}{\partial x_i} = \divt \boldsymbol F + \divt \boldsymbol G\]
