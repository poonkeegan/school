    ...
    \begin{enumerate}
        ...
        \begin{enumerate}[label=(\roman*)]
            ...
            \begin{align*}
                ...
                &= \sum_{i=1}^n \frac{\partial f}{\partial^2 x_i }g  + 2 \sum_{i=1}^n \bigg( \frac{\partial f}{\partial x_i } \cdot \frac{\partial g}{\partial x_i } \bigg) +\sum_{i=1}^n \frac{\partial g}{\partial^2 x_i }f \\
            \end{align*}
        \end{enumerate}
