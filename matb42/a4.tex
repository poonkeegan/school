...
\begin{enumerate}
    ...
    \item Find the work done by the force field $\boldsymbol{F}(x,y,z) = (xy,yz,zx)$ in moving a particle along the twisted cubic, $\gam(t) = (t,t^2,t^3)$, from $t=0$ to $t=1$.
        \begin{align*}
            ...
            &= \int_0^1 (t)(t^2)(1) + (t^2)(t^3)(2t) + (t^4)(t)(3t^2)dt \\
            &= \int_0^1 t^3 + 2t^6 + 3t^7 dt\\
            &= \frac{1}{4}\Big[t^4\Big]_0^1 + \frac{2}{7}\Big[t^7\Big]_0^1 + \frac{3}{8}\Big[t^8\Big]_0^1 \\
            &= \frac{2}{7} + \frac{5}{8} = \frac{51}{56} \\
        \end{align*}
    \newpage
