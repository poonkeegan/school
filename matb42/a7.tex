...
\begin{enumerate}
    ...
    \begin{align*}
        \boldsymbol \Phi(r,\theta) &= (r\cos\theta,\, r\sin\theta,\, 1 - r^2/2) \\
        \boldsymbol \phi_r &= (\cos\theta,\, \sin\theta,\,  -r) \\
        \boldsymbol \phi_{\theta} &= (-r\sin\theta,\, r\cos\theta,\, 0 ) \\
        \norm{\boldsymbol \phi_{\theta} \times \boldsymbol \phi_{\theta} }&= (r^2\sin\theta,\, r^2\cos\theta,\, r) \\
    \end{align*} 
\end{enumerate}
\end{document}
