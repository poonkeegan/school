    ...
    \begin{enumerate}
        ...
        \begin{align*}
            ...
            &=2 \Big( \Big[ \sec \theta \tan \theta \Big]_{\frac{\pi}{4}}^{\frac{\pi}{4}} - \int_{\frac{\pi}{4}}^{\frac{\pi}{4}} \tan^2 \theta \sec \theta \, d \theta \Big) \\
             ...
             2\int_{-\frac{\pi}{4}}^{\frac{\pi}{4}} \sec^3\theta\, d\theta   &= \Big( \Big[ \sec \theta \tan \theta \Big]_{\frac{\pi}{4}}^{\frac{\pi}{4}} + \int_{\frac{\pi}{4}}^{\frac{\pi}{4}} \sec \theta \frac{\sec \theta + \tan \theta}{\sec \theta + \tan \theta}\, d \theta \Big) \\
        \end{align*} 
    \end{enumerate}
    \newpage
