...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        So the exact intersection of the surfaces is a circle of radius $1/4$ centered at the origin. so the surface cut out, is the section of the top of the sphere w

        \item Find the area of the portion of the cone $z = \sqrt{x^2+y^2}$ that is cut out by the unit sphere.
        
        Plugging in $x^2 +y^2 = 1/2$ to the cone equation again gives $z^2 = 1/2 \implies z = \pm \frac{2}{\sqrt{2}}$ but $z \geq 0$ by the cone definition so $0 \leq z \leq \frac{\sqrt{2}}{2}$.
        \begin{align*}
