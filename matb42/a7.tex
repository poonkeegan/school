...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{align*}
            ...
            &= 2\int_{-\frac{\pi}{4}}^{\frac{\pi}{4}} \sec\theta(1 + \tan^2 \theta)\, d\theta  \\
            &= 2\Big(\int_{-\frac{\pi}{4}}^{\frac{\pi}{4}} \sec\theta \tan \theta + \int_{-\frac{\pi}{4}}^{\frac{\pi}{4}} \sec\theta \tan^2 \theta\Big)\, d\theta  \\
        \end{align*} 
    \end{enumerate}
    \newpage
