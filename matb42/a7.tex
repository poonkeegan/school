...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{align*}
            ...
            \int_{-\frac{\pi}{4}}^{\frac{\pi}{4}} \sec^3\theta\, d\theta   &=\Big( \Big[ \sec \theta \tan \theta \Big]_{\frac{\pi}{4}}^{\frac{\pi}{4}} - \int_{\frac{\pi}{4}}^{\frac{\pi}{4}} \sec^3 \theta \, d \theta  + \int_{\frac{\pi}{4}}^{\frac{\pi}{4}} \sec \theta \, d \theta \Big) \\
        \end{align*} 
    \end{enumerate}
    \newpage
