...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{align*}
            \boldsymbol \phi_u &= (2u, 0, 1) \\
            \boldsymbol \phi_v &= (1,1,2v) \\
            \boldsymbol \phi_u \times \boldsymbol \phi_v &= (-1,1-4uv,2u)
            \norm{\boldsymbol \phi_u \times \boldsymbol \phi_v} &= \sqrt{1 + (1-4uv)^2 + 4u^2}
        \end{align*}
