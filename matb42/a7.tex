...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{align*}
            ...
            &= 2\int_{-\frac{\pi}{4}}^{\frac{\pi}{4}} \sec^3\theta\, d\theta   &=2 \Big( \Big[ \sec \theta \tan \theta \Big]_{\frac{\pi}{4}}^{\frac{\pi}{4}} - \int_{\frac{\pi}{4}}^{\frac{\pi}{4}} (\sec^2 \theta - 1 )\sec \theta \, d \theta \Big) \\
            &=2 \Big( \Big[ \sec \theta \tan \theta \Big]_{\frac{\pi}{4}}^{\frac{\pi}{4}} - \int_{\frac{\pi}{4}}^{\frac{\pi}{4}} \sec^3 \theta \, d \theta  + \int_{\frac{\pi}{4}}^{\frac{\pi}{4}} \sec \theta \, d \theta \Big) \\
            &=2 \Big( \Big[ \sec \theta \tan \theta \Big]_{\frac{\pi}{4}}^{\frac{\pi}{4}} - \int_{\frac{\pi}{4}}^{\frac{\pi}{4}} \sec^3 \theta \, d \theta  + \int_{\frac{\pi}{4}}^{\frac{\pi}{4}} \sec \theta \, d \theta \Big) \\
            &=2 \Big( \Big[ \sec \theta \tan \theta \Big]_{\frac{\pi}{4}}^{\frac{\pi}{4}} - \int_{\frac{\pi}{4}}^{\frac{\pi}{4}} \sec^3 \theta \, d \theta  + \int_{\frac{\pi}{4}}^{\frac{\pi}{4}} \sec \theta \, d \theta \Big) \\
        \end{align*} 
    \end{enumerate}
