...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{align*}
            ...
            \implies A(S) &= a\int_0^{2\pi}\int_0^\pi \sin \varphi \, d\varphi \, d\theta \\
            &= \int_0^{2\pi}\Big[- \cos \varphi \Big]_0^{\pi} \, d\varphi \, d\theta \\
            &= \int_0^{2\pi}- (-1 - 1) \, d\varphi \, d\theta \\
            &= 2\int_0^{2\pi}1 \, d\varphi \, d\theta \\
            &= 4\pi\\
        \end{align*} 
