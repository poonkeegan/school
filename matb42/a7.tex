...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        So the exact intersection of the surfaces is a circle of radius $1/4$ centered at the origin. Plugging in $x^2 +y^2 = 1/2$ to the equation again gives $z^2 = 1/2 \implies z = \pm \frac{1}{4}$
