...
\begin{enumerate}
\item A particle moving on the curve $\gamma(t) = (3t^2, -\sin t, -e^t)$ is released at time $t=\frac{1}{2}$ and flies off on a tangent. What are its coordinates at time $t=1$. $\bm{\gamma}$
