...
\begin{enumerate}
    ...
    \item the curve of intersection of the cone $z=\sqrt{x^2 + y^2}$ and the sphere $x^2+y^2+z^2 = 2x$.
        ...
        \end{align*}
        From this ellipse equation, looking at the shift of the center of the ellipse and the constant factors, $x,y$ should be set to $\frac{\sin(t) + 1}{2}, \frac{\cos(t)}{2}.
