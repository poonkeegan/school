    ...
    \begin{enumerate}
        ...
        \item Show that $dF_1 \wedge dF_2 \wedge dF_3 = (\text{det } D \boldsymbol F ) \, dx \, dy \, dz$
            ...
            \begin{align*} 
                ...
                &= (\partis{x}{F_3} (\partis{x}{F_1} \partis{y}{F_2} - \partis{y}{F_1} \partis{x}{F_2}\, dx \, dy) \\
                &\; \; \; \; + (\partis{y}{F_1} \partis{z}{F_2} - \partis{z}{F_1} \partis{y}{F_2} \, dy \, dz) \\
                &\; \; \; \; + (\partis{z}{F_1} \partis{x}{F_2} - \partis{x}{F_1} \partis{z}{F_2} \, dz \, dx ))\wedge (\parti{x} F_3 \, dx + \parti{y} F_3 \, dy + \parti{z} F_3 \, dz) \\
            \end{align*} 
    \end{enumerate}
    \newpage
