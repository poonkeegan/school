...
\thispagestyle{fancy}
\begin{enumerate}
    \item Let $\boldsymbol F$ be a vector field on $\mathbb{R}^3$ given by 
        $\boldsymbol F = (F_1, F_2, F_3)$ where $F_1$, $F_2$, and $F_3$ 
        are $C^1$-functions from $\mathbb{R}^3 \rightarrow \mathbb{R}$
    \begin{enumerate}
    ...
    \begin{enumerate}
        ...
        to $\displaystyle \int_{\gamma} \omega$. Verify by direct computation.
            ...
            \begin{align*}
                \int_{\boldsymbol \gamma} \omega &= \int_1^{2\pi} 
                (2\sin t)(4)(-2\sin t) - (2\cos t)4(2\cos t) \, dt \\
                &= \int_0^{2\pi}  -16(\sin ^2 t + \cos ^2 t) \, dt \\
                &= \int_0^{2\pi} -16 \, dt  = -32 \pi\\
        ...
        If we take the vector field over $S$ and $S'$ as the flow of a substance
        through the surface, then intuitively, the rate of flow is restricted by
        boundary $\boldsymbol \gamma$. This means that, if the boundary remains
        the same, the flow cannot change independantly of the shape of the surface.
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Marsden \& Tromba, page 451, \# 15.
            ...
            \end{align*} 
            \end{multicols}
            The equation is that of a shifted ellipse. Solve both
            terms in terms of cos and sin.
            \begin{multicols}{2}
                \noindent
                \begin{align*}
                    \frac{3}{4}\bigg(y-\frac{1}{3}\bigg)^2 &= 
                    \frac{1}{3}\cos^2 \theta \\
                    \frac{1}{4}\bigg(y-\frac{1}{3}\bigg)^2 &= 
                    \frac{1}{9}\cos^2 \theta \\
                    \bigg(y-\frac{1}{3}\bigg)^2 &= 
                    \frac{4}{9}\cos^2 \theta \\
                    y-\frac{1}{3} &= 
                    \frac{2}{3}\cos \theta \\
                    y &= \frac{2}{3}\cos \theta + \frac{1}{3} \\
                \end{align*} 
                \begin{align*}
                    \bigg(x + \frac{y-1}{2}\bigg)^2 &= 
                    \frac{1}{3} \sin^2 \theta \\
                    x + \frac{y-1}{2} &= 
                    \frac{1}{\sqrt{3}} \sin \theta \\
                    x &= \frac{1}{\sqrt{3}} \sin \theta - \frac{y-1}{2} \\
                    x &= \frac{1}{\sqrt{3}} \sin \theta 
                    + \frac{1}{2}\bigg(\frac{2}{3} \cos \theta -
                    \frac{1}{3} - 1 \bigg) \\
                    x &= \frac{1}{\sqrt{3}} \sin \theta 
                    - \frac{1}{3} \cos \theta + \frac{1}{3}\\
                \end{align*}  
            \end{multicols}
            Plugging that back into the plane equation gives
            \begin{align*}
                z &= 1 - x - y \\
                z &= 1 - \bigg(\frac{1}{\sqrt{3}} \sin \theta 
                    - \frac{1}{3} \cos \theta + \frac{1}{3}\bigg) - 
                    \bigg(\frac{2}{3}\cos \theta + \frac{1}{3}\bigg) \\
                z &= 1  - \frac{1}{\sqrt{3}} \sin \theta 
                    + \frac{1}{3} \cos \theta - \frac{1}{3} - 
                    \frac{2}{3}\cos \theta - \frac{1}{3} \\
                z &= \frac{1}{3}  - \frac{1}{\sqrt{3}} \sin \theta 
                    - \frac{1}{3} \cos \theta \\
            \end{align*}   
            ...
            - \frac{1}{3} \cos \theta + \frac{1}{3} ,\,
            \frac{2}{3}\cos \theta + \frac{1}{3} ,\,
            \frac{1}{3}  - \frac{1}{\sqrt{3}} \sin \theta 
            - \frac{1}{3} \cos \theta \bigg)\]
            \[ \boldsymbol \gamma' (\theta) = 
            \bigg( 
            \frac{1}{\sqrt 3} \cos \theta + \frac{1}{3} \sin \theta,\,
            -\frac{2}{3} \sin \theta,\,
            \frac{-1}{\sqrt 3} \cos \theta + \frac{1}{3} \sin \theta
            \bigg)\]
            Examining the tangent at $\theta = 0$ shows that the direction
            is the wrong way (clockwise), so when taking the intergral, the
            orientation needs to be reversed.

            \begin{align*}
                \int_{\boldsymbol \gamma} \omega &= 
                \int_0^{2\pi} 2(x(\theta)+y(\theta)+z(\theta)) 
                \norm{\boldsymbol \gamma' (\theta)} \, d \theta \\
                &= 2 \int_0^{2\pi}
                \sqrt{\bigg(\frac{1}{\sqrt 3} \cos \theta \bigg)^2
                + \bigg(-\frac{2}{3} \sin \theta \bigg)^2
                + \bigg(\frac{-1}{\sqrt{3}} \cos \theta + \frac{1}{3}
                \sin \theta \bigg)^2} \, d \theta \\
                &= 2 \int_0^{2\pi}
                \frac{1}{3} \cos ^2 \theta + \frac{4}{9} \sin ^2 \theta
                + \frac{1}{3} \cos ^2 \theta - \frac{2}{3\sqrt 3} 
                \sin \theta \cos \theta + \frac{1}{9} \sin^2 \theta 
                \, d \theta \\
                &= 2 \int_0^{2\pi}
                \frac{1}{9} \cos ^2 \theta + \frac{5}{9} 
                 - \frac{2}{3\sqrt 3} 
                \sin \theta \cos \theta + \frac{1}{9} \sin^2 \theta 
                \, d \theta \\
            \end{align*}   
    ...
    \begin{enumerate}
        ...
        \begin{proof}
            ...
            \int_{R}  \divt (\boldsymbol F \times \text{curl} 
            \boldsymbol G) \cdot \, d V \\
            &\overset{\text{(i)}}{=} \int_{R} (\text{curl} \boldsymbol F) \cdot
            (\text{curl} \boldsymbol G) \cdot d V - \int_{R} \boldsymbol F \cdot 
            \text{curl}(\text{curl} \boldsymbol G) \cdot
            d \, V \\
            \end{align*} 
        \end{proof}
    \end{enumerate}
