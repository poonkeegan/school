...
\begin{enumerate}
    ...
    \begin{align*}
        ...
        & \; \; \; \; + \int_0^{2\pi} \int_0^{\pi} \sin\theta \sin\varphi \begin{vmatrix} \partis{\varphi}{\cos \varphi} & \partis{\theta}{\cos \varphi} \\ \partis{\varphi}{\cos\theta \sin\varphi} & \partis{\varphi}{\sin\theta \sin\varphi}\end{vmatrix}\, d\varphi \, d\theta \\
    \end{align*}
