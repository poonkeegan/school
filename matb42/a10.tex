...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Show that $dF_1 \wedge dF_2 \wedge dF_3 = (\text{det } D \boldsymbol F ) \, dx \, dy \, dz$
            \[ df = \sum_{i=0}^{n} \parti{x_i} f \, dx_i \]
            \begin{align*} 
                dF_1 \wedge dF_2 \wedge dF_3 &= (\parti{x} F_1 \, dx + \parti{y} F_1 \, dy + \parti{z} F_1 \, dz) \wedge (\parti{x} F_2 \, dx + \parti{y} F_2 \, dy + \parti{z} F_2 \, dz) \wedge dF_3 \\
                &= (\parti{x} F_1 \, dx \wedge (\parti{x} F_2 \, dx + \parti{y} F_2 \, dy + \parti{z} F_2 \, dz) \\
                &\; \; \; \; + \parti{y} F_1 \, dy \wedge (\parti{x} F_2 \, dx + \parti{y} F_2 \, dy + \parti{z} F_2 \, dz) \\
                &\; \; \; \; + \parti{z} F_1 \, dz \wedge (\parti{x} F_2 \, dx + \parti{y} F_2 \, dy + \parti{z} F_2 \, dz) ) \wedge dF_3 \\
                &= (\parti{x} F_1 \parti{y} F_2 \, dx \, dy + \parti{x} F_1 \parti{z} F_2 \, dx \, dz) \\
                &\; \; \; \; + \parti{y} F_1 \, dy \wedge (\parti{x} F_2 \, dx + \parti{y} F_2 \, dy + \parti{z} F_2 \, dz) \\
                &\; \; \; \; + \parti{z} F_1 \, dz \wedge (\parti{x} F_2 \, dx + \parti{y} F_2 \, dy + \parti{z} F_2 \, dz) ) \wedge dF_3 \\
            \end{align*} 
    \end{enumerate}
