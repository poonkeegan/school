...
\begin{enumerate}
    ...
    \item Verify Stokes' theorem by direct calculation of both sides when the surface $S$ is the piece of the paraboloid $z= x^2 + y^2 - 4$ with $z \leq 0$, oriented by the downward pointing unit normal, and $\oriented = (2y-z)\, dx + (x + y^2 - z)\, dy + (4y-3x)\, dz$.
\end{enumerate}
\end{document}
