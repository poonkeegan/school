...
\begin{enumerate}
    ...
    \begin{align*}
        ...
        & \; \; \; \; + \int_0^{2\pi} \int_0^{\pi} \sin\theta \sin\varphi \begin{vmatrix} \partis{\theta}{\sin\theta \sin\varphi} & \partis{\varphi}{\sin\theta \sin\varphi} \\ \partis{\theta}{\cos \varphi} & \partis{\varphi}{\cos \varphi} \end{vmatrix}\, d\varphi \, d\theta \\
    \end{align*}
