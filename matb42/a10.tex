...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Marsden \& Tromba, page 451, \# 15.
            ...
            \bigg(\frac{2}{3}\cos \theta + \frac{1}{3}, 
            \frac{1}{\sqrt{3}} \sin \theta + \frac{1}{3} 
            \cos \theta - \frac{5}{6}, \frac{3}{2} - \frac{1}{\sqrt 3 } 
            \sin \theta - \cos \theta \bigg)\]
            \[ \boldsymbol \gamma' (\theta) = 
            \bigg(- \frac{2}{3}\sin \theta , \frac{1}{\sqrt{3}} \cos \theta 
            - \frac{1}{3} \sin \theta, \frac{-1}{\sqrt 3 } \cos \theta 
            + \sin \theta \bigg)\]
