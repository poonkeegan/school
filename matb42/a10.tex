    ...
    \begin{enumerate}
        \item Let $\eta$ be the 2-form given by
            ...
            \begin{align*} 
                ...
                &= (\parti{x} F_3 \,dx + \parti{y} F_3 \, dy + \parti{z} F_3  \, dz)\, dx \, dy + (dF_2) \, dy \, dz + (dF_1) \, dz \, dx \\
                &= \parti{z} F_3  \, dz \, dx \, dy + (dF_2) \, dy \, dz + (dF_1) \, dz \, dx \\
                &= \parti{z} F_3  \, dx \, dy \, dz + (\parti{x} F_2 \,dx + \parti{y} F_2 \, dy + \parti{z} F_2  \, dz) \, dy \, dz + (dF_1) \, dz \, dx \\
            \end{align*} 
    \end{enumerate}
\end{enumerate}
\end{document}
