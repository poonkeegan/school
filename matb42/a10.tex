...
\begin{enumerate}
    ...
    As part of your solution, provide a sketch showing the appropriate orientations. (For this question you may draw the sketch by hand or use symbolic algebra software.)
        ...
        \begin{align*}
            \int_{\boldsymbol \gamma} (2(2\sin\theta) - 0)(-2\sin \theta) + ((2\cos \theta) + (2\sin \theta)^2 - 0)(2\cos \theta) \, d\theta &= \int_{\boldsymbol \gamma} -8 \sin ^2 \theta + 4 \cos ^2 \theta + 8 \sin^2 \theta \cos \theta
        \end{align*}
