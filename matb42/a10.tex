    ...
    \begin{enumerate}
        ...
        \item Show that $dF_1 \wedge dF_2 \wedge dF_3 = (\text{det } D \boldsymbol F ) \, dx \, dy \, dz$
            ...
            \begin{align*} 
                ...
                &= (\parti{x} F_1 \, dx \wedge (\parti{x} F_1 \, dx + \parti{y} F_1 \, dy + \parti{z} F_1 \, dz) +  \parti{y} F_1 \, dy + \parti{z} F_1 \, dz) \wedge (\parti{x} F_2 \, dx + \parti{y} F_2 \, dy + \parti{z} F_2 \, dz) \wedge dF_3 \\
            \end{align*} 
    \end{enumerate}
    \newpage
