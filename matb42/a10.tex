    ...
    \begin{enumerate}
        \item Let $S$ be the piece of the surface $z = x^2 + y^2$ with 
            ...
            \begin{align*}
                ...
                (2\sin \theta)(r^2)(-2\sin \theta) 
                - (2\cos \theta)(r^2)(2\cos \theta) \, dt 
                + (r\cos \\
        ...
        to $\displaystyle \int_{\gamma} \omega$. Verify by direct computation.
            ...
            \begin{align*}
                \int_{\boldsymbol \gamma} \omega &= \int_0^{2\pi} 
                (2\sin \theta)(4)(-2\sin \theta) - (2\cos \theta)4(2\cos \theta) \, d\theta \\
                &= \int_0^{2\pi}  -16(\sin ^2 \theta + \cos ^2 \theta) \, d\theta \\
                &= \int_0^{2\pi} -16 \, d\theta  = -32 \pi\\
