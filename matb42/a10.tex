...
\begin{enumerate}
    ...
    \begin{align*}
        ...
        &= \int_0^{2\pi} \int_0^{\pi} \cos \varphi \begin{vmatrix}{\partial{\theta}{\cos\theta \sin \varphi}} \, d\varphi \, d\theta + \iint_{\boldsymbol \Phi} x \, dy \, dz + \iint_{\boldsymbol \Phi} y \, dy \, dx \\
    \end{align*}
