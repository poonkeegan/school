...
\begin{enumerate}
    ...
    \begin{align*}
        ...
        &= \int_0^{2\pi} \int_0^{\pi} \cos \varphi \begin{vmatrix}\partis{\theta}{\cos\theta \sin \varphi} & \partis{\varphi}{\cos\theta \sin \varphi} \\ \partis{\theta}{\sin\theta \sin\varphi} & \partis{\varphi}{\sin\theta \sin\varphi} \end{vmatrix} \, d\varphi \, d\theta + \iint_{\boldsymbol \Phi} x \, dy \, dz + \iint_{\boldsymbol \Phi} y \, dy \, dx \\
    \end{align*}
