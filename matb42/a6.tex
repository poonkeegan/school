...
\begin{enumerate}
    ...
    \begin{align*}
        \int_{-1}^{1} \int_{-\sqrt{1-x^2}}^{\sqrt{1-x^2}}3x^2y^2dy\ dx &= \int_{\gam} F_2dx = \int_0^{2\pi} \cos^3t \sin^2t (- \sin t)\ dt \\
        &= - \int_0^{2\pi} \cos^3t \sin^3t\ dt = \int_0^{2\pi}\frac{1}{8}(2\sin t \cos t)^3 dt = - \int_0^{2\pi}\frac{1}{8}(\sin (2t))^3 dt \\
        &= - \int_0^{2\pi}\frac{1}{16}(1 - \cos^2(2t))(\sin (2t)) dt \\
        &\text{Let }u = \cos(2t), \: du = -2\sin(2t)dt \\
        &= \frac{1}{32} \int_0^{2\pi}(1 - u^2)du
    \end{align*}
    \newpage
