...
\begin{enumerate}
    ...
    \begin{align*}
        \int_{-1}^{1} \int_{-\sqrt{1-x^2}}^{\sqrt{1-x^2}}3x^2y^2dy\ dx &= \int_{\gam} F_2dx = \int_0^{2\pi} \cos^3t \sin^2t ( \cos t)\ dt \\
        &= \int_0^{2\pi} \cos^4t \sin^2t\ dt = \int_0^{2\pi}\frac{1}{8}(2\sin t \cos t)^3 dt = \int_0^{2\pi}\frac{1}{8}(\sin (2t))^3 dt \\
