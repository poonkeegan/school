...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        The equation for the tangent plane is given by $(\boldsymbol \phi_u \times \boldsymbol \phi_v \cdot (4-x,9-y,7-z))$. We know that $\boldsymbol \Phi (u_0, v_0) = (4,9,7)$ so $u_0 = $
    \end{enumerate}
    \newpage    
