...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        The equation for the tangent plane is given by $(\boldsymbol \phi_u \times \boldsymbol \phi_v \cdot (4-x,9-y,7-z))$. We know that $\boldsymbol \Phi (u_0, v_0) = (4,9,7)$ so $u_0 = 2, v_0 = 3$. This means the normal vector is $(-12,-4,12) \implies$ the tangent plane is $(-12)(4-x) + (-4)(9-y) + (12)(7-z)$.
    \end{enumerate}
    \newpage    
